    ...
    function updateMotionValuesFromProps(element, next, prev) {
        ...
        for (const key in next) {
            ...
            if (isMotionValue(nextValue)) {
                 ...
                 */
                {
                    warnOnce(nextValue.version === "10.13.2", `Attempting to mix Framer Motion versions ${nextValue.version} with 10.13.2 may not work as expected.`);
                }
            }
